...
const ASAppHeader = (_a) => {
    ...
    const renderActions = (alignment) => {
        ...
        return filteredActions.map((action, idx) => (react_1.default.createElement(react_native_1.TouchableOpacity, { key: `${alignment}-${idx}`, onPress: action.onPress, style: [stylesObj.actionButton, idx === filteredActions.length - 1 ? { marginRight: 0 } : null] }, renderIcon(action.icon, action.iconSize, action.color))));
    };
    ...
    return (react_1.default.createElement(react_native_1.View, Object.assign({}, restProps, { style: [customStyles, {
                paddingTop: ((_b = customStyles === null || customStyles === void 0 ? void 0 : customStyles.paddingTop) !== null && _b !== void 0 ? _b : 0) + ((_c = insets === null || insets === void 0 ? void 0 : insets.top) !== null && _c !== void 0 ? _c : 0), // Handle safe area view
                height: ((_d = customStyles === null || customStyles === void 0 ? void 0 : customStyles.height) !== null && _d !== void 0 ? _d : 0) + ((_e = insets === null || insets === void 0 ? void 0 : insets.top) !== null && _e !== void 0 ? _e : 0), // Handle safe area view
            }] }),
