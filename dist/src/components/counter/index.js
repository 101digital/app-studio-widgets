...
const ASCounter = ({ initialValue = 0, onValueChange, incrementIconColor = "#007AFF", decrementIconColor = "#007AFF", incrementIconSize = 24, decrementIconSize = 24, minValue = 0, maxValue, style, name, labelTypography }) => {
