...
const ASListView = (props) => {
    ...
    return (react_1.default.createElement(react_native_gesture_handler_1.FlatList, Object.assign({ data: data, renderItem: renderItem, keyExtractor: keyExtractor }, restProps)));
};
