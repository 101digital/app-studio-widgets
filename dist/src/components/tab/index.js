...
const ASTabs = ({ children, activeTabName, onTabPress, activeTabTextColor, activeTabBorderColor = "white", tabHeaderTypography, tabHeaderStyle, enableShadow = true, contentOffset = 1, tabViewStyle, style, id, tabTitleOffset = 8 }) => {
    var _a, _b;
