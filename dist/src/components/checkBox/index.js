...
var checkbox_1 = __importDefault(require("@react-native-community/checkbox"));
var colors_1 = require("../../utils/colors");
var ASCheckBox = function (props) {
    var onChange = props.onChange, restProps = __rest(props, ["onChange"]);
    var _a = (0, react_1.useState)(false), toggleCheckBox = _a[0], setToggleCheckBox = _a[1];
    var onValueChange = function (newValue) {
        setToggleCheckBox(newValue);
        onChange === null || onChange === void 0 ? void 0 : onChange(newValue);
    };
    return (react_1.default.createElement(checkbox_1.default, __assign({ disabled: false, value: toggleCheckBox, onValueChange: onValueChange, 
        //IOS Only Props
