...
const ASDatePicker = (props) => {
    ...
    const { name, onFocus, onBlur, suffixIcon, prefixIcon, prefixText, prefixTextStyle, formatError, label, formatNumber, labelTextStyle, inputTextStyle, borderErrorColor, borderActiveColor, style, errorMessageTextStyle, placeholderTextColor, accessibilityLabel, isOverlayEnabled, id, onChange, isDefaultCurrentDate, minDate, maxDate, range, displayDateFormat = "yyyy-MM-dd", selectedDateFormat = "yyyy-MM-dd", selectedDayBackgroundColor, selectedDayTextColor, todayTextColor, arrowColor, dayTextColor, calendarBackground, textSectionTitleColor, testId = "ASDatePicker" } = props, restProps = __rest(props, ["name", "onFocus", "onBlur", "suffixIcon", "prefixIcon", "prefixText", "prefixTextStyle", "formatError", "label", "formatNumber", "labelTextStyle", "inputTextStyle", "borderErrorColor", "borderActiveColor", "style", "errorMessageTextStyle", "placeholderTextColor", "accessibilityLabel", "isOverlayEnabled", "id", "onChange", "isDefaultCurrentDate", "minDate", "maxDate", "range", "displayDateFormat", "selectedDateFormat", "selectedDayBackgroundColor", "selectedDayTextColor", "todayTextColor", "arrowColor", "dayTextColor", "calendarBackground", "textSectionTitleColor", "testId"]);
    ...
    return (react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: onOpenIsVisible, style: [
            ...
            { paddingTop: 8 },
        ], accessibilityLabel: accessibilityLabel, id: id, testID: testId },
