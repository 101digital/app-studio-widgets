...
const DeleteIcon = ({ size = 26, color = colors_1.colors.primary }) => (React.createElement(react_native_svg_1.default, { width: size, height: size, viewBox: "0 0 26 26", fill: "none" },
