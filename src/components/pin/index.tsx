...
import {FlatList, FlatListProps, StyleProp, StyleSheet, TextInput, TextStyle, View, ViewStyle,} from "react-native";
...
const Keyboard: React.FC<KeyboardProps> = (props: KeyboardProps) => {
    ...
    return (
        <FlatList
            scrollEnabled={false}
            {...flatListProps}
            contentContainerStyle={[styles.flatListContainerStyles, StyleSheet.flatten(contentContainerStyle)]}
            columnWrapperStyle={[styles.flatListColumnWrapperStyle, StyleSheet.flatten(columnWrapperStyle)]}
            data={KEYBOARDS}
